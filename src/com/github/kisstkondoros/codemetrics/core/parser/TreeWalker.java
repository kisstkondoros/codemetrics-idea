...
public class TreeWalker {
  ...
  private MetricsModel getMetrics(PsiElement element) {
    ...
    if (element instanceof PsiArrayAccessExpression) {
      ...
      model =
          visit(element, configuration.assertStatement, configuration.assertStatementDescription);
      ...
      model =
          visit(element, configuration.binaryExpression, configuration.binaryExpressionDescription);
      ...
      model =
          visit(
              element, configuration.continueStatement, configuration.continueStatementDescription);
      ...
      model =
          visit(element, configuration.doWhileStatement, configuration.doWhileStatementDescription);
      ...
      model =
          visit(element, configuration.foreachStatement, configuration.foreachStatementDescription);
      ...
      model =
          visit(element, configuration.importStatement, configuration.importStatementDescription);
      ...
      model =
          visit(element, configuration.labeledStatement, configuration.labeledStatementDescription);
    } else if (element instanceof PsiLiteralExpression) {
      model =
          visit(
              element, configuration.literalExpression, configuration.literalExpressionDescription);
      ...
      model =
          visit(element, configuration.packageStatement, configuration.packageStatementDescription);
      ...
      model =
          visit(
              element, configuration.receiverParameter, configuration.receiverParameterDescription);
      ...
      model =
          visit(
              element,
              configuration.parenthesizedExpression,
              configuration.parenthesizedExpressionDescription);
    } else if (element instanceof PsiPostfixExpression) {
      model =
          visit(
              element, configuration.postfixExpression, configuration.postfixExpressionDescription);
    } else if (element instanceof PsiPrefixExpression) {
      model =
          visit(element, configuration.prefixExpression, configuration.prefixExpressionDescription);
    } else if (element instanceof PsiUnaryExpression) {
      model =
          visit(element, configuration.unaryExpression, configuration.unaryExpressionDescription);
    } else if (element instanceof PsiImportStaticReferenceElement) {
      model =
          visit(
              element,
              configuration.importStaticReferenceElement,
              configuration.importStaticReferenceElementDescription);
    } else if (element instanceof PsiMethodReferenceExpression) {
      model =
          visit(
              element,
              configuration.methodReferenceExpression,
              configuration.methodReferenceExpressionDescription);
    } else if (element instanceof PsiJavaCodeReferenceElement) {
      model =
          visit(element, configuration.referenceElement, configuration.referenceElementDescription);
      ...
      model =
          visit(
              element, configuration.typeParameterList, configuration.typeParameterListDescription);
    } else if (element instanceof PsiReturnStatement) {
      model =
          visit(element, configuration.returnStatement, configuration.returnStatementDescription);
    } else if (element instanceof PsiSuperExpression) {
      model =
          visit(element, configuration.superExpression, configuration.superExpressionDescription);
      ...
      model =
          visit(element, configuration.switchStatement, configuration.switchStatementDescription);
      ...
      model =
          visit(element, configuration.resourceVariable, configuration.resourceVariableDescription);
      ...
      model =
          visit(element, configuration.implicitVariable, configuration.implicitVariableDescription);
      ...
      model =
          visit(element, configuration.annotationMethod, configuration.annotationMethodDescription);
      ...
      if (elementType.equals(JavaTokenType.ANDAND) || elementType.equals(JavaTokenType.OROR)) {
        ...
        model =
            visit(
                element,
                complexity * configuration.polyadicExpression,
      ...
      model =
          visit(
              element,
              configuration.moduleReferenceElement,
              configuration.moduleReferenceElementDescription);
    } else if (element instanceof PsiRequiresStatement) {
      model =
          visit(
              element, configuration.requiresStatement, configuration.requiresStatementDescription);
    } else if (element instanceof PsiPackageAccessibilityStatement) {
      model =
          visit(
              element,
              configuration.packageAccessibilityStatement,
      ...
      model =
          visit(
              element, configuration.providesStatement, configuration.providesStatementDescription);
      ...
      model =
          visit(element, configuration.classInitializer, configuration.classInitializerDescription);
      ...
      model =
          visit(element, configuration.moduleStatement, configuration.moduleStatementDescription);
    }
    return model;
  }
